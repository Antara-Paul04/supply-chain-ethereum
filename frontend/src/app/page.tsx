    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-16">
          <Link href="/register/farmer" className="group">
          ...
          <Link href="/register/roaster" className="group">
            <div className="bg-white border border-gray-200 rounded-lg p-8 hover:shadow-lg transition-shadow">
              ...
              <div className="text-center">
                <span className="inline-flex items-center px-4 py-2 bg-orange-600 text-white rounded-md group-hover:bg-orange-700 transition-colors">
                  Join as Roaster
                </span>
              </div>
            </div>
